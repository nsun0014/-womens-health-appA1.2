          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5><i class="fas fa-chart-pie me-2"></i>Platform Health Metrics</h5>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <h6>User Activity Levels</h6>
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">
                        <span>New Users</span>
                        <strong>{{ getMetricPercentage('newUsers') }}%</strong>
                      </div>
                      <div class="progress mb-2">
                        <div
                          class="progress-bar bg-success"
                          :style="{ width: getMetricPercentage('newUsers') + '%' }"
                        ></div>
                      </div>
                    </div>
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">
                        ...
                        <strong>{{ getMetricPercentage('activeUsers') }}%</strong>
                      </div>
                      <div class="progress mb-2">
                        <div
                          class="progress-bar bg-primary"
                          :style="{ width: getMetricPercentage('activeUsers') + '%' }"
                        ></div>
                      </div>
                    </div>
                    <div class="mb-3">
                      <div class="d-flex justify-content-between">
                        <span>Health Goals Set</span>
                        <strong>{{ getMetricPercentage('healthGoals') }}%</strong>
                      </div>
                      <div class="progress">
                        <div
                          class="progress-bar bg-warning"
                          :style="{ width: getMetricPercentage('healthGoals') + '%' }"
                        ></div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="list-group list-group-flush">
                      <div class="list-group-item d-flex justify-content-between">
                        <span
                          ><i class="fas fa-users text-primary me-2"></i>Daily Active Users</span
                        >
                        <strong>{{ Math.round(platformStats.totalUsers * 0.7) }}</strong>
                      </div>
                      <div class="list-group-item d-flex justify-content-between">
                        <span
                          ><i class="fas fa-file-medical text-success me-2"></i>Profiles Created
                          Today</span
                        >
                        <strong>{{ Math.round(platformStats.healthProfiles * 0.1) }}</strong>
                      </div>
                      <div class="list-group-item d-flex justify-content-between">
                        <span><i class="fas fa-star text-warning me-2"></i>New Ratings</span>
                        <strong>{{ Math.round(platformStats.totalRatings * 0.15) }}</strong>
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    getMetricPercentage(metric) {
      const metrics = {
        newUsers: Math.min(85, 60 + this.platformStats.totalUsers * 5),
        activeUsers: Math.min(95, 70 + this.platformStats.healthProfiles * 3),
        healthGoals: Math.min(90, 50 + this.platformStats.averageRating * 10),
      }
